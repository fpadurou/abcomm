...
str_to_date( Date_updated, '%m/%d/%Y %H:%i'), _66, _67, CAST(SUBSTRING(_1,LOCATE('[',_1)+1, LOCATE(']',_1) - LOCATE('[',_1)-1) AS UNSIGNED),  CAST(_38 AS UNSIGNED), CAST(_38 AS UNSIGNED), CAST(_38 AS UNSIGNED), CAST(_38 AS UNSIGNED), CAST(_38 AS UNSIGNED), CAST(_38 AS UNSIGNED)
