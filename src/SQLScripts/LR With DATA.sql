...
INSERT INTO `tbl_sol_directory` (`solId`,`partNumber`,`solName`,`solDesc`,`partComSite`,`solFocus`,`sapCertSince`,`lastReviewBySAP`,`averTrainEndUser`,`averImplTrainingDays`,`averImplEffort`,`averImplDuration`,`averSizeImplTeam`,`averSaleCycle`,`noCustomers`,`smallImpl`,`largeImpl`,`smallImplTime`,`largeImplTime`,`smallImplTeamNo`,`largeImplTeamNo`,`solSite`,`refCustAvailForUse`,`totalAppBaseLinePrice`,`appPriceEur`,`hardwareCost`,`hardwareCostEur`,`averLicensePrice`,`averLicensePriceEur`,`addServiceCost`,`addServicePriceEur`,`implCost`,`implCostEur`,`sapDiscount`,`dbUsed`,`SAPBusUsed`,`SAPGUIUsed`,`compA1B1Used`,`thirdPartyUsed`,`thirdPartyName`,`otherIT`,`addRemarks`,`solSAPMicroSite`,`lastPartRevieDate`,`reviewedBy`,`profileAdded`,`dateCreated`,`modifiedBy`,`dateUpdated`,`notificationProc`,`companyId`) VALUES 
 ...
 (7482,'','R1 Rentals','R1 Rental provides the total solution for rental reservations, orders, tracking, services, billing and repairs of all types of fixed and mobile assets, equipments and inventory items. It is fully integrated with SAP Business One and Ceecom?s M1 Maintenance Add-on with identical SBO look and feel. Enables extensive drill downs and queries. Reports are provided throughout the system. R1 has a similar look and feel to SAP Business One and uses all native SAP Business One features.','http://cpsn-channel.sap.com/ceecom',1,'2005-09-27 00:00:00','2005-09-27 00:00:00',5,5,10,1,3,2,1,NULL,NULL,NULL,NULL,NULL,NULL,'','Yes',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'','MS SQL Server','Yes','Yes','','No','','','','','2005-10-25 00:00:00','','James Looseley','2005-09-20 14:29:00','CPSN Administrator','2005-09-20 14:29:00','Yes',NULL),
 (7487,'','OneEnterprise Portals','- Information sharing within the organization ? for Sales Executives, employees & Senior Executives and with its associates ? Vendors, Customers - Return merchandize authorization - Request a service call - Information on Best Selling - Products and new p','http://cpsn-channel.sap.com/citixsys',1,'2006-03-31 00:00:00','2006-03-31 00:00:00',5,7,7,1,5,2,18,5,20,7,14,2,5,'www.oneenterprise.com','Yes',4000,NULL,0,NULL,NULL,NULL,NULL,NULL,1200,NULL,'Yes','SQL Server 2000','Yes','No','','No','','','','http://cpsn-channel.sap.com/citixsys','2006-03-31 00:00:00','','Sarnath Mukherjee','2005-09-21 06:03:00','CPSN Administrator','2005-09-21 06:03:00','Yes',NULL),
 ...
 (8509,'','2B Exact','Conversion tool to import Exact installations into the SBO Database. Works for all Exact installations from DOS (Btrieve) to Exact Globe 2003. Uses an ACCESS database to be able to cleanup data and convert numbering schemes.','http://cpsn-channel.sap.com/2borbrix',1,'2005-09-27 00:00:00','2005-09-27 00:00:00',1,1,2,0,1,0,5,1,50,1,1,1,1,'www.2borbrix.nl','Yes',500,NULL,0,NULL,0,NULL,500,NULL,500,NULL,'No','MS-SQL, MS_ACCESS','No','No','','No','','','','http://cpsn-channel.sap.com/2Borbrix/Exact','2006-03-31 00:00:00','','M. R??ers','2005-09-26 03:29:00','CPSN Administrator','2005-09-26 03:29:00','Yes',NULL),
 ...
 (8517,'','Microshop Project Costing','Microshop Project Costing offers a complete ERP environment for companies who need to trade labor, inventory and misc. expenses for specific projects. The components included in Microshop Project Costing are all Business One modules and the Project Costing system. The major business processes supported are project tracking and costing, expense tracking and time and material billing.','http://cpsn-channel.sap.com/cdi-usa',1,'2005-09-27 00:00:00','2005-09-27 00:00:00',3,3,10,1,1,2,1,50,50,30,30,NULL,1,'http://www.cdi-usa.com','Yes',4159,NULL,0,NULL,415,NULL,0,NULL,4161,NULL,'Yes','SQL','Yes','Yes','All Business One modules and the Project Costing system','No','','','','http://cpsn-channel.sap.com/cdi-usa','2006-03-31 00:00:00','','Sandy DeAngelis','2005-09-26 15:23:00','CPSN Administrator','2005-09-26 15:23:00','Yes',NULL),
 (8519,'','UPS Wordship Interface','UPS Worldship Interface offers NO redundant entry into the shipping system. It has a seamless interface to Business One and is 100% imbedded into Business One. The business process supported is shipping integration to UPS Worldship automated manifest system. The components include all the Business One modules and the shipping interface.','http://cpsn-channel.sap.com/cdi-usa',1,'2005-09-27 00:00:00','2005-09-27 00:00:00',0,0,1,1,1,0,6,7,70,1,1,1,1,'www.cdi-usa.com','Yes',830,NULL,0,NULL,0,NULL,0,NULL,415,NULL,'Yes','SQL','Yes','Yes','All Business One modules and Shipping Interface','Yes','UPS Worldship','','','http://cpsn-channel.sap.com/cdi-usa','2006-03-31 00:00:00','','Sandy DeAngelis','2005-09-26 15:59:00','CPSN Administrator','2005-09-26 15:59:00','Yes',NULL),
 ...
 (8526,'','Intercompany Solution','Intercompany Postings provides the mechanism to post between different companies within SAP Business One Any posting performed through the General Ledger can be trapped, with the transactions being transferred to a destination company. The Intercompany from/to accounts is set up in the system (COA) and this provides transparent inter-company posting for the user. As all the trigger and posting accounts are pre-defined, the operator simply has to choose the right accounts numbers. These companies are identified as part of a segment in the Chart of accounts definition. The user can select the posting periods and the Intercompany From/To accounts to trigger the posting.','',1,'2006-03-31 00:00:00','2006-03-31 00:00:00',3,3,4,0,4,1,1,10,NULL,5,NULL,NULL,NULL,'','No',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Yes','SQL Server 2000','Yes','Yes','','No','','','#NAME?','','2006-03-31 00:00:00','','Sarnath Mukherjee','2005-09-27 03:37:00','CPSN Administrator','2005-09-27 03:37:00','Yes',NULL),
 (8609,'','Congo','Fully B1 integrated Business-to-Business and/or Business-to-consumer website.','',1,'2006-03-31 00:00:00','2006-03-31 00:00:00',3,3,10,1,2,3,2,30,60,10,10,2,2,'','Yes',32000,NULL,7500,NULL,1000,NULL,NULL,NULL,12000,NULL,'Yes','SQL Server','Yes','No','B1 DI SDK','No','','','','','2006-03-31 00:00:00','','John Friebel','2005-10-02 22:42:00','CPSN Administrator','2005-10-02 22:42:00','Yes',NULL),
 ...
 (8648,'','R2p?atnikSBO','R2p?atnikSBO provides all the functionality required to human resources management, payroll counting in compliance with current regulations in Poland. R2p?atnikSBO is integrated with SAP Business One. Payrols are automatically booked in the accounting module of Business One and personal data of employees can be updated. Solution can be suited to company of every profile.','',1,'2006-03-31 00:00:00','2006-03-31 00:00:00',5,5,5,1,1,3,6,1,10,1,10,1,1,'http://www.reset2.pl/sap','Yes',2000,NULL,NULL,NULL,1000,NULL,NULL,NULL,1500,NULL,'Yes','Microsoft SQL Server','Yes','Yes','','No','','','','','2006-03-31 00:00:00','','Jerzy Szczesnik','2005-10-11 11:26:00','CPSN Administrator','2005-10-11 11:26:00','Yes',NULL),
 (8686,'','ASS.TEC BOne WIN','The main functionality of the ASS.TEC MSWord-Interface is to create single letters and mass mailing to business partners directly from SAP Business One. During this process you can choose to create activities automatically. Starting with Version 2004 2.0 which is available since 1st May 2005 you also can create the follow-up action with certain criteria, as well as mark the origin activity as opened or closed. A special highlight: With the integration of the SAP Business One query generator or wizard into the mass mailing creation all relevant SAP Business One ? data may be selected and printed in the mass mailing. Details about the functionality and technical procedure for licensing you will find in the documentation: www2.asstec.com/BOne-WIN','',1,'2005-12-20 00:00:00','2005-12-20 00:00:00',0,0,0,NULL,1,0,8,1,10,0,0,NULL,NULL,'www2.asstec.com/BOne-WIN','Yes',NULL,NULL,NULL,NULL,NULL,80,NULL,NULL,NULL,NULL,'Yes','Microsoft SQL Server','Yes','Yes','','Yes','Microsoft','','','','2005-12-20 00:00:00','','Martina Kohler','2005-10-17 06:35:00','CPSN Administrator','2005-10-17 06:35:00','Yes',NULL),
 ...
 (8778,'','Bank Statement Import','It allows importing statement bank files automatically. It dynamically set up different bank files format.','',1,'2006-03-31 00:00:00','2006-03-31 00:00:00',1,1,1,NULL,1,1,3,3,10,1,1,1,1,'www.apollocon.com','Yes',500,413,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'','SQL Server','Yes','Yes','','No','','','','','2005-10-24 00:00:00','Hector Ritondale','Scott.McMahon','2005-10-24 15:30:00','CPSN Administrator','2005-10-24 15:30:00','Yes',NULL),
 (8782,'','iRequest - Purchase Requisitioning','iRequest is a web based purchase requistioning system developed for SAP Business One that allows to enter a purchase request for items or services, follow it to an approval process and post it in SAP Business One as a purchase order. It includes RFQs, XML punchout and a very flexible workflow creation module. You can also follow the flow of the requisition, from PO cration to Invoicing , etc','',1,'2006-03-31 00:00:00','2006-03-31 00:00:00',1,1,2,NULL,1,1,1,3,100,1,3,NULL,NULL,'www.apollocon.com','Yes',3000,2500,0,0,150,125,NULL,NULL,NULL,NULL,'Yes','SQL Server','Yes','No','','No','','','','','2006-02-06 00:00:00','Scott McMahon','Scott.McMahon','2005-10-25 13:19:00','Scott.McMahon','2006-02-06 15:28:00','Yes',NULL);
