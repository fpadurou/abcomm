...
CREATE TABLE `tbl_sol_to_solsapallinone` (
  `solId` int(20) NOT NULL,
  `id` int(20) NOT NULL,
  PRIMARY KEY  (`solId`,`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
